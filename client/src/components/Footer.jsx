      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 mb-4 max-w-md">
              Making cities better, one complaint at a time. Your voice matters
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li>
                <Link
                  to="/login"
                  className="text-mid-gray hover:text-teal transition-colors"
                >
                  Login
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li>
                <a
                  href="mailto:amarjb721@gmail.com?subject=CityCare Support Request&body=Hello CityCare Team,%0D%0A%0D%0AI need help regarding..."
                  className="text-mid-gray hover:text-teal transition-colors"
                >
                  Contact
                </a>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 text-center">
          <p className="text-mid-gray">
            &copy; 2024 CityCare. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
